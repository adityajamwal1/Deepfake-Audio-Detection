...
app.title("Deepfake Audio Detection")
...
def run():
    ...
    if not dir:
        ...
        entry_result.insert("0", "Please select an audio file.")
        return
    ...
    completion_label = customtkinter.CTkLabel(master=app, text=f"{run.completion_counter}. operation completed")
...
def my_fun():
    ...
    my_dir1 = filedialog.askopenfilename(filetypes=[("Audio Files", "*.wav")])
...
logo_image = customtkinter.CTkImage(Image.open("images/ai.png"), size=(64, 64))
